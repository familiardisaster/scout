...
python3 /home/ubuntu/scout/perms.py $2
...
python3 /home/ubuntu/scout/pathor.py $2 content.txt paths.txt
python3 /home/ubuntu/scout/urlor.py $2 content.txt urls.txt

#Assemble all known paths and params wordlists
#TODO: FIX THIS
python3 /home/ubuntu/scout/urlparse.py $2

#TODO: Custom wordlist for ffuf discovery using perms and paths appended to default, b00mlike list
python3 /home/ubuntu/scout/pathpender.py $2
python3 /home/ubuntu/scout/fuzzmagic.py
...
python3 /home/ubuntu/scout/pathor.py $2 ffout.txt paths.txt

#Create custom meg input file with protocols
python3 /home/ubuntu/scout/megprep.py $2
